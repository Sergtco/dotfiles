...
in {
  ...
  services.zapret = {
    ...
    params = [
      ...
      "--filter-tcp=443  --ip-id=zero --dpi-desync=fake --dpi-desync-repeats=6 --dpi-desync-fooling=badseq --dpi-desync-badseq-increment=2 --dpi-desync-fake-tls=${client_hello} --hostlist ${hostlist} --new"
